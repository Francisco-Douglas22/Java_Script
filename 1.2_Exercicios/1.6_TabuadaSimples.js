/*6 - Faça um programa que leia um número Inteiro qualquer e mostre na tela a
sua tabuada. OBS sem uƟliza laço de repeƟção ou mesmo funções*/

const numero = 5;

//Tabuda sem laço de repetição ou mesmo funcoes e condicoes
